...
public class Frame {
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		DrawableHelper.fill(matrices, x, y, x + width, y + height, new Color(0, 150, 0).getRGB());
		mc.textRenderer.drawWithShadow(matrices, category.name, x + 2, y + (height / 2) - mc.textRenderer.fontHeight / 2, Color.YELLOW.getRGB());
		mc.textRenderer.drawWithShadow(matrices, extended ? "-" : "+", x + width - 2 - mc.textRenderer.getWidth("+"), y + (height / 2) - mc.textRenderer.fontHeight / 2, Color.YELLOW.getRGB());
