...
//set of parallel horizontal lines------------------------------------------------------------------------------------------------------------------
	...
	public static void drawTexture(MatrixStack matrixStack, Vec3d position, int width, int height, int textureWidth, int textureHeight, Identifier  texture) {
		position = transformVec3d(position);
		
		RenderSystem.setShaderTexture(0, texture);
		DrawableHelper.drawTexture(matrixStack, (int)position.x, (int)position.y, (int)position.z, 0, 0, width, height, textureWidth, textureHeight);
	}
