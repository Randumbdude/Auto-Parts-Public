...
public class Frame {
	...
	public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
		DrawableHelper.fill(matrices, x, y, x + width, y + height, new Color(0, 0, 0, 140).getRGB());
		
		OtherRenderUtils.drawBoxOutline(matrices, x, y, x + width, y + height, new ColorUtil(0,0,0));
