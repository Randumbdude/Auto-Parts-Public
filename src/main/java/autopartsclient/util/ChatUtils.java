...
public enum ChatUtils
{
	...
	public static void decryptedComponent(Text component)
	{
		if(!enabled)
			return;
	...
	public static void decryptedMessage(String message) {
	    decryptedComponent(Text.literal("\u00A7bDecrypted: \u00A7c" + message));
	}
}