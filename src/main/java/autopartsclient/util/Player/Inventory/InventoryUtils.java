package autopartsclient.util.Player.Inventory;
    ...
    */
    ...
    public static void quickMoveItem(int slot) {
        if (mc.player.currentScreenHandler instanceof ShulkerBoxScreenHandler) {
            ...
            mc.getNetworkHandler().sendPacket(new ClickSlotC2SPacket(screenHandler.syncId, 0, slot, 0, SlotActionType.QUICK_MOVE, screenHandler.getSlot(0).getStack(), (Int2ObjectMap) stack));
        }
    }
}